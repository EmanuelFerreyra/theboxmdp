...
<div class="container mt-4">
    <div class="col-sm-12 text-center border-bottom p-3">
        <h3 class="font-w400"> Resultado de Búsqueda: <strong class="font-w700"> {{ $word  }} </strong></h3>
    </div>
</div>
...
@if( count($products) <= 0 )
    <div class="container mt-4">
        <div class="col-sm-12 text-center border-bottom p-3">
            <h3 class="font-w400"> <strong class="font-w700"> No se encontro nada relacionado a {{ $word }}</strong></h3>
        </div>
    </div>
